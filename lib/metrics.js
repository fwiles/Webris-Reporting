...
// Top 10 ads by spend as structured rows for the dashboard table. Each row carries the
// creative thumbnail (thumbnail_url) plus MTD spend / leads / CPL. Sibling to
// topAdsForNote below, which formats a string for the AI prompt.
export function topAds(adRows, accountName) {
